package com.luckypan.common.aspect;
...
import com.luckypan.common.utils.VerifyUtils;
...
public class GlobalOperationAspect {
    ...
    @Pointcut("@annotation(com.luckypan.common.annotation.GlobalInterceptor)")
    ...
    private void checkLogin(Boolean checkAdmin) {
        ...
        SessionWebUserDto sessionUser = (SessionWebUserDto) session.getAttribute(Const.SESSION_KEY);
...
//                session.setAttribute(Const.SESSION_KEY, sessionUser);
//            }
//        }
        if (null == sessionUser) {
